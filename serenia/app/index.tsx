  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.content}>
        ...
        <Animated.View style={[styles.illustrationContainer, { opacity: fadeAnim, transform: [{ scale: fadeAnim }] }]}>
           <View style={styles.iconCircle}>
             <Ionicons name="leaf" size={80} color="#3D6056" />
           </View>
           {/* Decorative elements around */}
           <Ionicons name="sparkles" size={24} color="#C8E6C9" style={styles.sparkle1} />
           <Ionicons name="heart" size={20} color="#FFCC80" style={styles.sparkle2} />
        </Animated.View>
        ...
        <Animated.View style={[styles.textContainer, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            <Text style={styles.subtitle}>
                Votre compagnon quotidien pour cultiver le calme, suivre vos émotions et grandir en toute sérénité.
            </Text>
        </Animated.View>

        <Animated.View style={{ opacity: fadeAnim, width: '100%', alignItems: 'center', marginTop: 40 }}>
